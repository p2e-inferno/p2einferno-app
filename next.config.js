  ...
  headers: async () => {
    const buildCsp = () => {
      const directives = [
        ...
        "child-src https://auth.privy.io https://privy.p2einferno.com https://verify.walletconnect.com https://verify.walletconnect.org",
        "frame-src https://auth.privy.io https://privy.p2einferno.com https://verify.walletconnect.com https://verify.walletconnect.org https://challenges.cloudflare.com https://checkout.paystack.com https://js.paystack.co https://*.paystack.com",
        "worker-src 'self'",
        "manifest-src 'self'",
