  ...
  headers: async () => {
    const buildCsp = () => {
      const directives = [
        ...
        `img-src 'self' data: blob: https://*.public.blob.vercel-storage.com https:${process.env.NODE_ENV === 'development' ? ' http://127.0.0.1:54321 http://localhost:54321' : ''}`,
        "connect-src " + [
          "'self'",
          process.env.NEXT_PUBLIC_APP_URL,
          process.env.NODE_ENV === 'development' ? 'http://127.0.0.1:54321 http://localhost:54321' : '',
          "https://vercel.com",
          "https://*.vercel.com",
          "https://blob.vercel-storage.com",
          "https://*.public.blob.vercel-storage.com",
          "https://auth.privy.io",
          "https://privy.p2einferno.com",
          "wss://privy.p2einferno.com",
