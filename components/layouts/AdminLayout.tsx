...
import { Menu, X, HomeIcon, BookOpen, Users, Award, FileText, CreditCard, Settings, ChevronLeft, ChevronRight } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="bg-gray-900 border-b border-gray-800">
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-flame-yellow">Admin Panel</h1>
              <span className="text-gray-400 text-xs">P2E Inferno Management</span>
            </div>
          </div>
          <PrivyConnectButton />
        </div>
      ...
      <div className="flex">
        ...
        {isDesktop && (
        <div className={`${sidebarExpanded ? 'w-64' : 'w-16'} bg-gray-900 min-h-screen transition-all duration-300 ease-in-out`}>
          <div className="p-4">
