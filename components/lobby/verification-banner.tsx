...
export const VerificationBanner: React.FC = () => {
    ...
    if (!ready || !authenticated || isLoading || (verification?.isWhitelisted && !verification?.needsReVerification)) {
        return null;
    }

    return (
        <div id="gooddollar-verification" className="relative overflow-hidden group mb-8 scroll-mt-24">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start gap-6 text-center md:text-left">
                    ...
                    <div className="max-w-xl">
                        ...
                        <p className="text-gray-400 text-sm md:text-base leading-relaxed">
                            Verify your identity with GoodDollar to unlock exclusive high-reward quests and prove your uniqueness in the P2E INFERNO ecosystem.
                        </p>
                    </div>
                </div>
