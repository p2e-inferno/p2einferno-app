-- Migration: 038_fix_ambiguous_column_references.sql
...
RETURNS TABLE (
    ...
    message TEXT,
    enrollment_id UUID,
    returned_application_id UUID  -- RENAMED to avoid ambiguity
)
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
BEGIN
    ...
    -- 5. Handle user_application_status with fully qualified column references
    BEGIN
