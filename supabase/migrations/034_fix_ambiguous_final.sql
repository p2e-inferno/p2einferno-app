-- DEFINITIVE FIX: Completely eliminate ambiguity in handle_successful_payment function
-- This approach avoids all potential column reference conflicts
...
BEGIN
    ...
    -- 5. FIXED: Use separate operations to avoid ambiguity completely
    -- First, try to insert the new record
    BEGIN
