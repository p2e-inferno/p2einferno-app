-- 079_secure_milestone_progress_triggers.sql
-- Secure milestone progress trigger functions that were missed in earlier security migrations
-- These functions execute when task submissions are updated by admins and need proper search_path

-- ============================================================================
-- SECURITY: Add search_path to milestone progress trigger functions
-- ============================================================================

-- 1. Recreate update_user_milestone_progress() with security
...
-- 2. Recreate update_task_progress_on_submission() with security
...
-- Note: Triggers are already created in migration 045, no need to recreate them
-- This migration only updates the function definitions
