...
ADD COLUMN key_token_id TEXT,
ADD COLUMN network_chain_id BIGINT;

-- Add indexes for blockchain fields
CREATE INDEX idx_payment_transactions_transaction_hash 
  ON public.payment_transactions(transaction_hash) 
  WHERE transaction_hash IS NOT NULL;

CREATE INDEX idx_payment_transactions_network_chain_id 
