...
CREATE OR REPLACE FUNCTION "public"."check_duplicate_submission"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF EXISTS (
...
ALTER FUNCTION "public"."check_duplicate_submission"() OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "prevent_duplicate_submissions" BEFORE INSERT OR UPDATE ON "public"."task_submissions" FOR EACH ROW EXECUTE FUNCTION "public"."check_duplicate_submission"();
...
GRANT ALL ON FUNCTION "public"."check_duplicate_submission"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_duplicate_submission"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_duplicate_submission"() TO "service_role";
