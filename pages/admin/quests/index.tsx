...
import { DailyQuestList } from "@/components/admin/DailyQuestList";
...
export default function AdminQuestsPage() {
  ...
  return (
    <AdminListPageLayout
      ...
      newButtonText={
        activeTab === "daily" ? "Create Daily Quest" : "Create Quest"
      }
      newButtonLink={
        activeTab === "daily" ? "/admin/quests/daily/new" : "/admin/quests/new"
      }
      isLoading={activeTab === "daily" ? false : loading}
      error={activeTab === "daily" ? null : error}
      onRetry={activeTab === "daily" ? undefined : handleRetry}
      isRetrying={activeTab === "daily" ? false : isRetrying}
      isEmpty={
        activeTab === "daily"
          ? false
    ...
    >
      <Tabs
        value={activeTab}
        onValueChange={(v) =>
          router.replace(`/admin/quests?tab=${v}`, undefined, { shallow: true })
        }
      >
        ...
        <TabsContent value="quests">
          <div className="grid gap-4 md:gap-6">
            {quests.map((quest) => {
              const sortedTasks =
                sortQuestTasks(quest as any).quest_tasks || [];
              return (
                <div
                  key={quest.id}
                ...
                >
                  ...
                  <div className="md:hidden">
                    ...
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex flex-wrap gap-2 items-center">
                          ...
                          />
                          {quest.stats &&
                            quest.stats.pending_submissions > 0 && (
                    ...
                    <div className="flex flex-wrap gap-1 mb-3">
                      {sortedTasks.slice(0, 4).map((task: QuestTask) => (
                        <div
                          key={task.id}
                      ...
                      <div className="flex items-start space-x-4 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2 mb-3">
                            {sortedTasks.slice(0, 5).map((task: QuestTask) => (
                              <div
                                key={task.id}
