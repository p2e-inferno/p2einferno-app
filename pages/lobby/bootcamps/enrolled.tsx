...
export default function EnrolledBootcampsPage() {
  ...
  const calculateOverallProgress = (enrollment: any) => {
    ...
    const { total_milestones, completed_milestones } =
      enrollment.milestone_progress;
    return total_milestones > 0
      ? Math.round((completed_milestones / total_milestones) * 100)
      : 0;
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Track your progress in enrolled bootcamp programs"
        />
      </Head>
          ...
          {enrollments.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-faded-grey mb-8 max-w-md mx-auto">
                You haven&apos;t enrolled in any bootcamps yet. Browse available
                programs to start your learning journey.
              </p>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          >
                            ...
                            <span
                              className={`text-sm font-medium capitalize ${getStatusColor(enrollment.enrollment_status)}`}
                            >
                      ...
                      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                        <div className="bg-background/30 rounded-xl p-4 text-center">
                          ...
                          <div className="font-bold">
                            {enrollment.cohort.bootcamp_program.duration_weeks}{" "}
                            Weeks
                          </div>
                        ...
                        <div className="bg-background/30 rounded-xl p-4 text-center">
                          ...
                          <div className="font-bold">
                            ...
                            /
                            {enrollment.milestone_progress?.total_milestones ||
                              0}
                          </div>
                          <div className="text-xs text-faded-grey">
                            Milestones
                      ...
                      {enrollment.milestone_progress?.current_milestone && (
                        <div className="bg-flame-yellow/10 border border-flame-yellow/20 rounded-xl p-4 mb-6">
                          <div className="flex items-center justify-between mb-2">
                            <h5 className="font-bold text-flame-yellow">
                              Current Milestone
                            </h5>
                          ...
                          <div className="w-full bg-flame-yellow/20 rounded-full h-2 mt-2">
                            <div
                              ...
                              style={{
                                width: `${enrollment.milestone_progress.current_milestone.progress_percentage}%`,
                              }}
                            />
                          </div>
                        </div>
