...
export const STATUS_HIERARCHY = {
  payment: ['pending', 'processing', 'completed', 'failed', 'refunded'] as const,
  application: ['draft', 'submitted', 'under_review', 'approved', 'rejected', 'withdrawn'] as const,
  enrollment: ['pending', 'active', 'completed', 'dropped', 'suspended', 'expired'] as const,
} as const;
